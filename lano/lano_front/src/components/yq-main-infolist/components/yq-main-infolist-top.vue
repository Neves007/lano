<template>
    <div style="display: flex;flex-flow: column nowrap">
        <el-row class="shuxing" style="padding-left: 10px; display: flex;flex-flow: column nowrap">
            ...
            <div>
                <div style="display: flex;flex-flow: row nowrap;">
                    ...
                    <!--</el-col>-->
                    <el-col span="12">
                        <div style="font-size: 14px; display: inline-block">情感属性：</div>
                        <el-radio-group v-model="infolist_filter.match_method_radio" class="cu_infolist_radio">
            ...
            <div style="display: flex;flex-flow: row nowrap;">
                <el-col span="12">
                    ...
                    <el-checkbox-group v-model="infolist_filter.source_type_checkList" class="laiyuanleixing"
                        ...
                        <el-checkbox label="定向信源"></el-checkbox>
                ...
                <el-col span="12">
                    <div style="font-size: 14px; display: inline-block">预警级别：</div>
                    <el-radio-group v-model="infolist_filter.match_method_radio" class="cu_infolist_radio">
                        <el-radio :label="1">高危预警</el-radio>
                        <el-radio :label="2">中危预警</el-radio>
                        <el-radio :label="3">低危预警</el-radio>
                    </el-radio-group>
                </el-col>
            </div>
            <hr style="background-color:#d2d5db;height: 1px;border: none;"/>
        ...
        <!--<el-row style="padding-left: 10px;margin-bottom: 0px">-->
            <!--<div style="display: flex;flex-flow: row nowrap;">-->
                <!--<el-col>-->
                    <!--<div style="font-size: 14px; display: inline-block;">分类：</div>-->
                    <!--<el-checkbox class="laiyuanleixing"-->
                                 <!--:indeterminate="infolist_filter.isIndeterminate"-->
                                 <!--v-model="infolist_filter.domain_checkAll"-->
                                 <!--@change="source_type_handleCheckAllChange">全选-->
                    ...
                    <!--<el-checkbox-group v-model="infolist_filter.source_type_checkList" class="laiyuanleixing"-->
                                       <!--@change="search_source" style="margin-left: 10px">-->
                        <!--<el-checkbox label="微博">微博</el-checkbox>-->
                        <!--&lt;!&ndash;<el-checkbox label="2">网站</el-checkbox>&ndash;&gt;-->
                        <!--<el-checkbox label="微信">微信</el-checkbox>-->
                        <!--<el-checkbox label="论坛">论坛</el-checkbox>-->
                        <!--&lt;!&ndash;<el-checkbox label="客户端"></el-checkbox>&ndash;&gt;-->
                        <!--<el-checkbox label="新闻">新闻</el-checkbox>-->
                        <!--<el-checkbox label="定向信源"></el-checkbox>-->
                        <!--&lt;!&ndash;<el-checkbox label="报刊"></el-checkbox>&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-checkbox label="外媒"></el-checkbox>&ndash;&gt;-->
                    <!--</el-checkbox-group>-->
                    <!--&lt;!&ndash;<el-tooltip class="item" effect="dark" content="新闻类型是具有新闻类备案号，或宣传部主办的网站，大型网站的新闻版块"-->
                                <!--placement="right">-->
                        <!--<i class="el-icon-question custom-helper-info"></i>-->
                    <!--</el-tooltip>&ndash;&gt;-->
                    <!--<el-tooltip class="item" effect="dark" content="点击跳转至定向监测" placement="top">-->
