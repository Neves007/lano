...
INSERT INTO `lano_end_exclude_web` VALUES (1,'四川省教育考试院','http://www.sceea.cn',1,73);
/*!40000 ALTER TABLE `lano_end_exclude_web` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lano_end_exclude_wechat`
--

DROP TABLE IF EXISTS `lano_end_exclude_wechat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `lano_end_exclude_wechat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `lano_end_exclude_wechat`
--

LOCK TABLES `lano_end_exclude_wechat` WRITE;
/*!40000 ALTER TABLE `lano_end_exclude_wechat` DISABLE KEYS */;
INSERT INTO `lano_end_exclude_wechat` VALUES (1,'123','11111',1,73),(3,'央视新闻','weixinid',1,74);
/*!40000 ALTER TABLE `lano_end_exclude_wechat` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `lano_end_exclude_weibo` VALUES (1,'电子科大','11111',1,73),(3,'央视新闻','12345',1,74);
...
-- Dump completed on 2019-04-03 17:37:10
